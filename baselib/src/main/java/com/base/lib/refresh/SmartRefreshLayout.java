...
import com.base.lib.refresh.api.DefaultRefreshFooterCreator;
import com.base.lib.refresh.api.DefaultRefreshHeaderCreator;
import com.base.lib.refresh.api.DefaultRefreshInitializer;
import com.base.lib.refresh.api.RefreshContent;
import com.base.lib.refresh.api.RefreshFooter;
import com.base.lib.refresh.api.RefreshHeader;
import com.base.lib.refresh.api.RefreshInternal;
import com.base.lib.refresh.api.RefreshKernel;
import com.base.lib.refresh.api.RefreshLayout;
import com.base.lib.refresh.api.ScrollBoundaryDecider;
import com.base.lib.refresh.constant.DimensionStatus;
...
import com.base.lib.refresh.header.BezierRadarHeader;
import com.base.lib.refresh.impl.RefreshContentWrapper;
import com.base.lib.refresh.impl.RefreshFooterWrapper;
import com.base.lib.refresh.impl.RefreshHeaderWrapper;
import com.base.lib.refresh.listener.OnLoadMoreListener;
import com.base.lib.refresh.listener.OnMultiPurposeListener;
import com.base.lib.refresh.listener.OnRefreshListener;
import com.base.lib.refresh.listener.OnRefreshLoadMoreListener;
import com.base.lib.refresh.listener.OnStateChangedListener;
import com.base.lib.refresh.util.DelayedRunnable;
import com.base.lib.refresh.util.DensityUtil;
import com.base.lib.refresh.util.ViscousFluidInterpolator;
...
import static com.base.lib.refresh.util.DensityUtil.dp2px;
import static com.base.lib.refresh.util.SmartUtil.fling;
import static com.base.lib.refresh.util.SmartUtil.getColor;
import static com.base.lib.refresh.util.SmartUtil.isContentView;
...
//    }
    ...
    /**
     * 设置多功能监听器
     * @param listener 建议使用 {@link com.base.lib.refresh.listener.SimpleMultiPurposeListener}
     * @return SmartRefreshLayout
     */
    @Override
    ...
    /**
     * 设置滚动边界
     * @param boundary 建议使用 {@link ScrollBoundaryDecider}
     * @return SmartRefreshLayout
     */
    @Override
