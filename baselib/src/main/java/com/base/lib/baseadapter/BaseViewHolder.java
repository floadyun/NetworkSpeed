...
public class BaseViewHolder extends RecyclerView.ViewHolder {
     ...
     *
     * @param viewId     The view id.
     * @param imageUrl The image resource id.
     * @return The BaseViewHolder for chaining.
     */
    public BaseViewHolder setImageUrl(Context context, int viewId,@DrawableRes int placeDrawable,String imageUrl) {
        ImageView view = getView(viewId);
        GlideManage.getInstance().with(context,placeDrawable,imageUrl,view);
        return this;
    }
    /**
