...
public class FJEditTextCount extends RelativeLayout {
    ...
    public interface OnEditTextCountListener{
        void onEditTextCount(int length);
    }
    ...
    private OnEditTextCountListener onEditTextCountListener;

    public void setOnEditTextCountListener(OnEditTextCountListener onEditTextCountListener) {
        this.onEditTextCountListener = onEditTextCountListener;
    }
    ...
    public FJEditTextCount(Context context, AttributeSet attrs) {
        super(context, attrs);
        View contentView = LayoutInflater.from(context).inflate(R.layout.fj_edittext_count, this, true);
        ...
        if (typedArray != null) {
//            contentView.setBackgroundResource(typedArray.getResourceId(R.styleable.FJEditTextCount_backgroudDrawable,R.drawable.white_text_bg_color));
            ...
            //最大字符
            MaxNum = typedArray.getInt(R.styleable.FJEditTextCount_etMaxLength, 1000);
            //横线颜色
            ...
            //设置提示统计文字大小
            tvNum.setTextSize(typedArray.getDimensionPixelSize(R.styleable.FJEditTextCount_etPromptTextSize,14));
            //设置提示统计文字颜色
            tvNum.setTextColor(typedArray.getColor(R.styleable.FJEditTextCount_etPromptTextColor, Color.BLACK));
            //设置提示统计显示类型
            int t = typedArray.getInt(R.styleable.FJEditTextCount_etType,1);
    ...
    private TextWatcher mTextWatcher = new TextWatcher() {
        ...
        public void afterTextChanged(Editable s) {
            ...
            etContent.addTextChangedListener(mTextWatcher);
            setLeftCount();
            if(onEditTextCountListener!=null){
                onEditTextCountListener.onEditTextCount(editEnd);
            }
        }
