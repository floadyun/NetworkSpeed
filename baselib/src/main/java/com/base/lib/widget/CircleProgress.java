...
import com.base.lib.util.Constant;
import com.base.lib.util.DeviceUtils;
import com.base.lib.util.MiscUtil;
...
public class CircleProgress extends View {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        mValueSize = typedArray.getInteger(R.styleable.CircleProgressBar_valueSize, Constant.DEFAULT_VALUE_SIZE);
        ...
        mArcWidth = typedArray.getInteger(R.styleable.CircleProgressBar_arcWidth, Constant.DEFAULT_ARC_WIDTH);
        ...
        mBgArcWidth = typedArray.getInteger(R.styleable.CircleProgressBar_bgArcWidth, Constant.DEFAULT_ARC_WIDTH);
    ...
    private void initPaint() {
        ...
        mValuePaint.setTextSize(DeviceUtils.getDeviceDimen(mContext,(int)mValueSize));
...
//         float textWidth = mValuePaint.measureText(String.valueOf(mValue)+" %");
        String valueText = "满";
        if(mValue<100){
            valueText = String.format(mPrecisionFormat, mValue)+mUnit;
        }
        canvas.drawText(valueText, mCenterPoint.x, mValueOffset, mValuePaint);
        if (mHint != null) {
//            canvas.drawText(mHint.toString(), mCenterPoint.x, mHintOffset, mHintPaint);
        }
        if (mUnit != null) {
//            canvas.drawText(mUnit.toString(), mCenterPoint.x+textWidth/2+5, mValueOffset, mUnitPaint);
        }
    }
