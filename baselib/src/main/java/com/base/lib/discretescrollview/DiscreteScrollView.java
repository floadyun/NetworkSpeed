...
import com.base.lib.discretescrollview.transform.DiscreteScrollItemTransformer;
import com.base.lib.discretescrollview.util.ScrollListenerAdapter;
...
public class DiscreteScrollView extends RecyclerView {
    ...
    private static final int DEFAULT_ORIENTATION = DSOrientation.HORIZONTAL.ordinal();
    ...
    private void init(AttributeSet attrs) {
        ...
        layoutManager = new DiscreteScrollLayoutManager(
                getContext(), new ScrollStateListener(), DSOrientation.HORIZONTAL);
    ...
    public void setOrientation(DSOrientation orientation) {
