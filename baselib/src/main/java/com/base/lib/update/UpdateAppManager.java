...
public class UpdateAppManager {
    ...
    private void processData(String result, @NonNull UpdateCallback callback) {
        try {
            ...
            if(AppUpdateUtils.isUpVersion(mUpdateApp.getBuild_number(),mActivity)){
    ...
    public static class Builder {
         ...
         * @return 是否忽略版本
         */
        public Builder showIgnoreVersion(boolean isShowIngore) {
            mShowIgnoreVersion = isShowIngore;
            return this;
        }
