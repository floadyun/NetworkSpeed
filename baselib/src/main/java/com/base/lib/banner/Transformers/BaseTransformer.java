package com.base.lib.banner.Transformers;
 ...
 *
 * BaseTransformer implement {@link  com.bear.custom.banner.Tricks.ViewPagerEx.PageTransformer}
 * which is just same as {@link android.support.v4.view.ViewPager.PageTransformer}.
 *
 * After you call setPageTransformer(), transformPage() will be called by {@link  com.bear.custom.banner.Tricks.ViewPagerEx}
 * when your slider are animating.
 *
 * In onPreTransform() function, that will make {@link  com.bear.custom.banner.Animations.BaseAnimationInterface}
 * work.
 *
